...
import net.mebahel.antiquebeasts.entity.armor.ValkyrieArmorRenderer;
...
public class ValkyrieArmorItem extends ArmorItem implements GeoItem {
    ...
    public ValkyrieArmorItem(ArmorMaterial materialIn, Type type, Settings builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private ValkyrieArmorRenderer renderer;

            @Override
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                        EquipmentSlot equipmentSlot, BipedEntityModel<LivingEntity> original) {
                if (this.renderer == null)
                    this.renderer = new ValkyrieArmorRenderer();
