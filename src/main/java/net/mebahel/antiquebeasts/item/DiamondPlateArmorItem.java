...
public class DiamondPlateArmorItem extends ArmorItem implements IAnimatable {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = new HashSet<>(armorList).containsAll(Arrays.asList(ModItems.DIAMOND_PLATE_BOOTS,
