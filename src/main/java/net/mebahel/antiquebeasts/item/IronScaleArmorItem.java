...
import net.mebahel.antiquebeasts.entity.armor.IronScaleArmorRenderer;
...
public class IronScaleArmorItem extends ArmorItem implements GeoItem {
    ...
    public IronScaleArmorItem(ArmorMaterial materialIn, Type type, Settings builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private IronScaleArmorRenderer renderer;

            @Override
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                        EquipmentSlot equipmentSlot, BipedEntityModel<LivingEntity> original) {
                if (this.renderer == null)
                    this.renderer = new IronScaleArmorRenderer();
