...
import net.mebahel.antiquebeasts.entity.armor.IronScaleArmor.IronScaleArmorRenderProvider;
...
public class IronScaleArmorItem extends ArmorItem implements GeoItem {
    ...
    public IronScaleArmorItem(ArmorMaterial material, Type type, Settings settings) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        // NOTE: classe client-only, mais OK tant que tu ne l’instancies que côté client
        consumer.accept(new IronScaleArmorRenderProvider());
    }
