...
import net.mebahel.antiquebeasts.entity.armor.DiamondScaleArmorRenderer;
...
public class DiamondScaleArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    private Supplier<Object> renderProvider;

    public DiamondScaleArmorItem(ArmorMaterial materialIn, Type type, Settings builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        if (FabricLoader.getInstance().isModLoaded("fabric")) {
            consumer.accept(new RenderProvider() {
                private DiamondScaleArmorRenderer renderer;

                @Override
                public @NotNull BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                                     EquipmentSlot equipmentSlot, BipedEntityModel<LivingEntity> original) {
                    if (this.renderer == null)
                        this.renderer = new DiamondScaleArmorRenderer();
