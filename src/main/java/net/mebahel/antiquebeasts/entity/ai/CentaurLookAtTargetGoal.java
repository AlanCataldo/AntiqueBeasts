...
public class CentaurLookAtTargetGoal extends Goal {
    private final CentaurEntity shade;
    private double deltaX;
    private double deltaZ;
    private int lookTime;

    public CentaurLookAtTargetGoal(CentaurEntity shade) {
        this.shade = shade;
        this.setControls(EnumSet.of(Control.LOOK));
    }

    public boolean canStart() {
        return this.shade.getTarget() != null && this.shade.isArcher();
    }
    public boolean shouldContinue() {
        return this.lookTime >= 0 && this.shade.getTarget() != null && this.shade.isArcher();
    }
