...
public class CyclopsMeleeAttackGoal extends Goal {
    ...
    private static final int MAX_COOLDOWN = 32;
    ...
    public void tick() {
        ...
        if (livingEntity != null) {
            ...
            System.out.print("[CD : " + this.cooldown + "]\n");
    ...
    protected void attack(LivingEntity target, double squaredDistance) {
        ...
        if (squaredDistance <= d && this.cooldown <= 0) {
            this.cooldown = MAX_COOLDOWN;
        } else if (squaredDistance <= d && this.cooldown == 31) {
            this.mob.swingHand(Hand.MAIN_HAND);
        } else if (squaredDistance <= d && this.cooldown == 26) {
