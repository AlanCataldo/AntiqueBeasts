...
public class EinherjarModel extends AnimatedGeoModel<EinherjarEntity> {
    float head_x;
    float head_y;
    ...
    @Override
    public Identifier getTextureResource(EinherjarEntity object) {
        return EinherjarRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }
    ...
    @Override
    public void setCustomAnimations(EinherjarEntity animatable, int instanceId, AnimationEvent animationEvent) {
