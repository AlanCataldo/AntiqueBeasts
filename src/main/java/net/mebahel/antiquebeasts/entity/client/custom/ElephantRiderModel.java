...
public class ElephantRiderModel extends AnimatedGeoModel<ElephantRiderEntity> {
    float head_x;
    float head_y;
    ...
    public static final Map<EgyptiantVariant, Identifier> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(EgyptiantVariant.class), (map) -> {
                map.put(EgyptiantVariant.DEFAULT,
                        new Identifier(AntiqueBeasts.MOD_ID, "textures/entity/elephant_rider_texture.png"));
                map.put(EgyptiantVariant.CLOAK,
                        new Identifier(AntiqueBeasts.MOD_ID, "textures/entity/elephant_rider_texture.png"));
            });
    @Override
    public Identifier getModelResource(ElephantRiderEntity object) {
        return new Identifier(AntiqueBeasts.MOD_ID, "geo/elephant_rider.geo.json");
    }

    @Override
    public Identifier getTextureResource(ElephantRiderEntity animatable) {
        return LOCATION_BY_VARIANT.get(animatable.getVariant());
    }
    @Override
    public Identifier getAnimationResource(ElephantRiderEntity animatable) {
        return new Identifier(AntiqueBeasts.MOD_ID, "animations/elephant_rider.animation.json");
    }
    @Override
    public void setCustomAnimations(ElephantRiderEntity animatable, int instanceId, AnimationEvent animationEvent) {
