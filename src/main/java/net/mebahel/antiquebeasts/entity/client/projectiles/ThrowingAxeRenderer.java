...
public class ThrowingAxeRenderer extends GeoEntityRenderer<ThrowingAxeEntity> {
    public ThrowingAxeRenderer(EntityRendererFactory.Context renderManager) {
        super(renderManager, new ThrowingAxeModel());
    }
    @Override
    public RenderLayer getRenderType(ThrowingAxeEntity animatable, Identifier texture, @Nullable VertexConsumerProvider bufferSource, float partialTick) {
