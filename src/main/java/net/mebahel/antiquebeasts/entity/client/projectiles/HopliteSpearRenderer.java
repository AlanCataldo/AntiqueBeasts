...
public class HopliteSpearRenderer extends GeoEntityRenderer<HopliteSpearEntity> {
    ...
    @Override
    public void preRender(MatrixStack poseStack, HopliteSpearEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
                          float alpha) {
