...
public class InfernalDraugrPotionLayer extends BlockAndItemGeoLayer<InfernalDraugrEntity> {

    public InfernalDraugrPotionLayer(GeoRenderer<InfernalDraugrEntity> renderer) {
        super(renderer);
    }

    @Override
    protected ItemStack getStackForBone(GeoBone bone, InfernalDraugrEntity animatable) {
