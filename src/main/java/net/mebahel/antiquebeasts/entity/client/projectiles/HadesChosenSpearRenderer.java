...
public class HadesChosenSpearRenderer extends GeoEntityRenderer<HadesChosenSpearEntity> {
    ...
    @Override
    public void preRender(MatrixStack poseStack, HadesChosenSpearEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
                          float alpha) {
