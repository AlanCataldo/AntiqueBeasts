...
public class FrostCyclopsRenderer extends GeoEntityRenderer<FrostCyclopsEntity> {
    ...
    public void preRender(MatrixStack poseStack, FrostCyclopsEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
                          float alpha) {
