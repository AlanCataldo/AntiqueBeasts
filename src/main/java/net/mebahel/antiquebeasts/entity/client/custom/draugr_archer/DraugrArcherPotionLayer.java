...
public class DraugrArcherPotionLayer extends BlockAndItemGeoLayer<DraugrArcherEntity> {

    public DraugrArcherPotionLayer(GeoRenderer<DraugrArcherEntity> renderer) {
        super(renderer);
    }

    @Override
    protected ItemStack getStackForBone(GeoBone bone, DraugrArcherEntity animatable) {
