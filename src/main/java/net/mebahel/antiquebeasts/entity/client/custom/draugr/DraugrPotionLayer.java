...
public class DraugrPotionLayer extends BlockAndItemGeoLayer<DraugrEntity> {

    public DraugrPotionLayer(GeoRenderer<DraugrEntity> renderer) {
        super(renderer);
    }

    @Override
    protected ItemStack getStackForBone(GeoBone bone, DraugrEntity animatable) {
