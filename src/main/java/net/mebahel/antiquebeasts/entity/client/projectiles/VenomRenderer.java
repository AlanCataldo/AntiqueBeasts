...
public class VenomRenderer extends GeoProjectilesRenderer<VenomEntity> {
    public VenomRenderer(EntityRendererFactory.Context renderManager) {
        super(renderManager, new VenomModel());
    }
    @Override
    public RenderLayer getRenderType(VenomEntity animatable, float partialTick, MatrixStack poseStack,
