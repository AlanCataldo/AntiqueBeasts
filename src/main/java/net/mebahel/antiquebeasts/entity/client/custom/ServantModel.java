...
public class ServantModel extends AnimatedGeoModel<ServantEntity> {
    float head_x;
    float head_y;
    ...
    @Override
    public void setCustomAnimations(ServantEntity animatable, int instanceId, AnimationEvent animationEvent) {
