...
public class HersirModel extends AnimatedGeoModel<HersirEntity> {
    ...
    @Override
    public void setCustomAnimations(HersirEntity animatable, int instanceId, AnimationEvent animationEvent) {
