...
public class AxemanModel extends AnimatedGeoModel<AxemanEntity> {
    float head_x;
    float head_y;
    ...
    @Override
    public void setCustomAnimations(AxemanEntity animatable, int instanceId, AnimationEvent animationEvent) {
