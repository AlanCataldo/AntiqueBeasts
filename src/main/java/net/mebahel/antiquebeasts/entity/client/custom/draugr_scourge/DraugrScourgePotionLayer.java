...
public class DraugrScourgePotionLayer extends BlockAndItemGeoLayer<DraugrScourgeEntity> {

    public DraugrScourgePotionLayer(GeoRenderer<DraugrScourgeEntity> renderer) {
        super(renderer);
    }

    @Override
    protected ItemStack getStackForBone(GeoBone bone, DraugrScourgeEntity animatable) {
