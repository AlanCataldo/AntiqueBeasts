...
public class ValkyrieSpearEntity extends PersistentProjectileEntity implements IAnimatable {
    ...
    public ValkyrieSpearEntity(EntityType<? extends ValkyrieSpearEntity> entityType, World world) {
        super(entityType, world);
        this.tridentStack = new ItemStack(ModItems.VALKYRIE_SPEAR);
    }

    public ValkyrieSpearEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.VALKYRIE_SPEAR, owner, world);
        this.tridentStack = new ItemStack(ModItems.VALKYRIE_SPEAR);
    ...
    static {
        LOYALTY = DataTracker.registerData(ValkyrieSpearEntity.class, TrackedDataHandlerRegistry.BYTE);
        ENCHANTED = DataTracker.registerData(ValkyrieSpearEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
}
