...
import static net.mebahel.antiquebeasts.entity.ModEntities.VENOM_SLOW;

public class VenomSlowEntity extends ThrownItemEntity implements IAnimatable {
    float damage;
    public VenomSlowEntity(EntityType<? extends VenomSlowEntity> entityType, World world) {
    ...
    public VenomSlowEntity(World world, LivingEntity owner, float damage) {
        super(VENOM_SLOW, owner, world);
        this.damage = damage;
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        if (entityHitResult.getEntity() instanceof LivingEntity) {
            ...
            if (!target.isBlocking()) {
                target.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 4 * 20, 0));
            }
    ...
    private void generateParticles() {
        ParticleEffect particleEffect = ModParticles.VENOM_SLOW_PARTICLE;
        for (int i = 0; i < 18; i++) {
