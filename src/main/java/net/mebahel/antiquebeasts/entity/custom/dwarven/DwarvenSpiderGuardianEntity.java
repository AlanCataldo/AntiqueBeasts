...
public class DwarvenSpiderGuardianEntity extends DwarvenEntity implements GeoEntity {
    ...
    public static final TrackedData<Boolean> SHOOTING = DataTracker.registerData(DwarvenSpiderGuardianEntity.class,
            TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Boolean> SWINGING = DataTracker.registerData(DwarvenSpiderGuardianEntity.class,
            TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Float> COOLDOWN = DataTracker.registerData(DwarvenSpiderGuardianEntity.class,
            TrackedDataHandlerRegistry.FLOAT);
    public static final TrackedData<String> ATTACK_NAME = DataTracker.registerData(DwarvenSpiderGuardianEntity.class,
            TrackedDataHandlerRegistry.STRING);
    public static final TrackedData<Boolean> IS_MINING = DataTracker.registerData(DwarvenSpiderGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Integer> MINING_COOLDOWN = DataTracker.registerData(DwarvenSpiderGuardianEntity.class, TrackedDataHandlerRegistry.INTEGER);

    private final AnimatableInstanceCache factory = new SingletonAnimatableInstanceCache(this);

    public DwarvenSpiderGuardianEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static final TrackedData<String> CURRENT_ANIMATION = DataTracker.registerData(DwarvenSpiderGuardianEntity.class, TrackedDataHandlerRegistry.STRING);
    @Override
    public void tick() {
        super.tick();
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(1, new CustomRevengeGoal(this, DwarvenSpiderGuardianEntity.class));
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(DwarvenSpiderGuardianEntity.class, TrackedDataHandlerRegistry.INTEGER);
