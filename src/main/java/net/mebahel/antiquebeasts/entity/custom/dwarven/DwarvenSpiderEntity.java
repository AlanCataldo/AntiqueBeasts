...
import net.mebahel.antiquebeasts.entity.ai.dwarven.dwarven_spider.MineOreGoal;
...
public class DwarvenSpiderEntity extends DwarvenEntity implements GeoEntity {
    ...
    public static final TrackedData<Boolean> SHOOTING = DataTracker.registerData(DwarvenSpiderEntity.class,
            TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Boolean> SWINGING = DataTracker.registerData(DwarvenSpiderEntity.class,
            TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Float> COOLDOWN = DataTracker.registerData(DwarvenSpiderEntity.class,
            TrackedDataHandlerRegistry.FLOAT);
    public static final TrackedData<String> ATTACK_NAME = DataTracker.registerData(DwarvenSpiderEntity.class,
            TrackedDataHandlerRegistry.STRING);
    public static final TrackedData<Boolean> IS_MINING = DataTracker.registerData(DwarvenSpiderEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Integer> MINING_COOLDOWN = DataTracker.registerData(DwarvenSpiderEntity.class, TrackedDataHandlerRegistry.INTEGER);

    private final AnimatableInstanceCache factory = new SingletonAnimatableInstanceCache(this);

    public DwarvenSpiderEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static final TrackedData<String> CURRENT_ANIMATION = DataTracker.registerData(DwarvenSpiderEntity.class, TrackedDataHandlerRegistry.STRING);
    @Override
    public void tick() {
        super.tick();
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new DwarvenSpiderMeleeAttackGoal(this, 1f, 15, 6, 7));
        this.goalSelector.add(3, new MineOreGoal(this));
        this.goalSelector.add(5, new DwarvenSpiderWanderFarGoal(this, 1f, 1f));
        //this.goalSelector.add(6, new LookAroundGoal(this));

        this.targetSelector.add(1, new CustomRevengeGoal(this, DwarvenSpiderEntity.class));
    ...
    public void collectDroppedItems(BlockPos pos) {
        World world = this.getWorld();
        net.minecraft.block.BlockState blockState = world.getBlockState(pos);

        // Récupérer les vrais drops du bloc avec un outil simulé
        java.util.List<net.minecraft.item.ItemStack> drops = net.minecraft.block.Block.getDroppedStacks(
                blockState, (net.minecraft.server.world.ServerWorld) world, pos, null);

        // Stocker les items minés
        for (net.minecraft.item.ItemStack drop : drops) {
            minedResources.add(drop);
            System.out.println("📦 Dwarven Spider a récupéré : " + drop);
        }
    }
    ...
    public void onDeath(net.minecraft.entity.damage.DamageSource source) {
        ...
        for (net.minecraft.item.ItemStack stack : minedResources) {
    ...
    private <E extends GeoAnimatable> PlayState predicate(AnimationState<E> event) {
        ...
        } else if (this.getDataTracker().get(DwarvenSpiderEntity.IS_MINING)) {
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(DwarvenSpiderEntity.class, TrackedDataHandlerRegistry.INTEGER);
