...
public class DwemerEntity extends AnimalEntity {
    private final List<ItemStack> minedResources = new java.util.ArrayList<>();
    double rand;

    public static final TrackedData<Boolean> SHOOTING = DataTracker.registerData(DwemerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    public static final TrackedData<Boolean> SWINGING = DataTracker.registerData(DwemerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    public static final TrackedData<Float> COOLDOWN = DataTracker.registerData(DwemerEntity.class, TrackedDataHandlerRegistry.FLOAT);

    public static final TrackedData<String> ATTACK_NAME = DataTracker.registerData(DwemerEntity.class, TrackedDataHandlerRegistry.STRING);
    public static final TrackedData<Boolean> IS_MINING = DataTracker.registerData(DwemerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Integer> MINING_COOLDOWN = DataTracker.registerData(DwemerEntity.class, TrackedDataHandlerRegistry.INTEGER);

    public DwemerEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static final TrackedData<String> CURRENT_ANIMATION = DataTracker.registerData(DwemerEntity.class, TrackedDataHandlerRegistry.STRING);
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(DwemerEntity.class, TrackedDataHandlerRegistry.INTEGER);
