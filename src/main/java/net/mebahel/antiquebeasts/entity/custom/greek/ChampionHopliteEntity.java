...
public class ChampionHopliteEntity extends GreekEntity implements GeoEntity {
    ...
    public static DefaultAttributeContainer.Builder setAttributes() {
        return HostileEntity.createMobAttributes()
                ...
                .add(EntityAttributes.GENERIC_MAX_HEALTH, 28.0D + ModBonusHealthConfig.championHopliteBonusHealth)
        ...
        if (source.getAttacker() instanceof ZombieEntity) {
            if (this.random.nextFloat() < 0.25f) {
                ...
                if (newZombie != null) {
                    ...
                    newZombie.equipStack(EquipmentSlot.HEAD, new ItemStack(ModItems.GOLD_PLATE_HELMET));
                    newZombie.equipStack(EquipmentSlot.CHEST, new ItemStack(ModItems.GOLD_PLATE_CHESTPLATE));
                    newZombie.equipStack(EquipmentSlot.LEGS, new ItemStack(ModItems.GOLD_PLATE_LEGGINGS));
                    newZombie.equipStack(EquipmentSlot.FEET, new ItemStack(ModItems.GOLD_PLATE_BOOTS));
                    newZombie.equipStack(EquipmentSlot.MAINHAND, new ItemStack(ModItems.GOLD_HOPLITE_SPEAR));
                    newZombie.equipStack(EquipmentSlot.OFFHAND, new ItemStack(ModItems.GOLD_PLATE_SHIELD));
    ...
    public static boolean canMobSpawnWithRate(EntityType<? extends AnimalEntity> type, ServerWorldAccess world, SpawnReason spawnReason, BlockPos pos, net.minecraft.util.math.random.Random random) {
        ...
        return randomValue < ModSpawnRateConfig.championHopliteSpawnRate;
    }
}
