...
public class DwemerSpiderEntity extends DwemerEntity implements GeoEntity {
    ...
    public static final TrackedData<Boolean> SHOOTING = DataTracker.registerData(DwemerSpiderEntity.class,
            TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Boolean> SWINGING = DataTracker.registerData(DwemerSpiderEntity.class,
            TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Float> COOLDOWN = DataTracker.registerData(DwemerSpiderEntity.class,
            TrackedDataHandlerRegistry.FLOAT);
    public static final TrackedData<String> ATTACK_NAME = DataTracker.registerData(DwemerSpiderEntity.class,
            TrackedDataHandlerRegistry.STRING);
    public static final TrackedData<Boolean> IS_MINING = DataTracker.registerData(DwemerSpiderEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    public static final TrackedData<Integer> MINING_COOLDOWN = DataTracker.registerData(DwemerSpiderEntity.class, TrackedDataHandlerRegistry.INTEGER);

    private final AnimatableInstanceCache factory = new SingletonAnimatableInstanceCache(this);

    public DwemerSpiderEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static final TrackedData<String> CURRENT_ANIMATION = DataTracker.registerData(DwemerSpiderEntity.class, TrackedDataHandlerRegistry.STRING);
    @Override
    public void tick() {
        super.tick();
    ...
    private <E extends GeoAnimatable> PlayState predicate(AnimationState<E> event) {
        ...
        } else if (this.getDataTracker().get(DwemerSpiderEntity.IS_MINING)) {
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(DwemerSpiderEntity.class, TrackedDataHandlerRegistry.INTEGER);
