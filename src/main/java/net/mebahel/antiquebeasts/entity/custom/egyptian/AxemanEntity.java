...
public class AxemanEntity extends EgyptianEntity implements IAnimatable, IAnimationTickable {
    ...
    public void registerControllers(AnimationData data) {
        AnimationController<AxemanEntity> controller = new AnimationController<>(this, "controller", 0,
                this::movementPredicate);
        AnimationController<AxemanEntity> controller1 = new AnimationController<>(this, "attacking", 0, this::attackPredicate);
        AnimationController<AxemanEntity> controller2 = new AnimationController<>(this, "procedure", 0, this::procedurePredicate);
