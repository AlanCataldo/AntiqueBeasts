...
public class HuskarlEntity extends AnimalEntity implements IAnimatable, IAnimationTickable {
    ...
    public static final TrackedData<String> ATTACK_NAME = DataTracker.registerData(HuskarlEntity.class,
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new HuskarlMeleeAttackGoal(this, 0.46f, false));
    ...
    public void registerControllers(AnimationData data) {
        AnimationController<HuskarlEntity> controller = new AnimationController<>(this, "controller", 0,
                this::movementPredicate);
        AnimationController<HuskarlEntity> controller1 = new AnimationController<>(this, "attacking", 0, this::attackPredicate);
        AnimationController<HuskarlEntity> controller2 = new AnimationController<>(this, "procedure", 0, this::procedurePredicate);
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(HuskarlEntity.class, TrackedDataHandlerRegistry.INTEGER);
