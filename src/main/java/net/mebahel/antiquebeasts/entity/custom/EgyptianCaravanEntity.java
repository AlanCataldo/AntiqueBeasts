...
public class EgyptianCaravanEntity extends EgyptianEntity implements GeoEntity {
    ...
    public EgyptianCaravanEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new CaravanEscapeDangerGoal(this, 0.45f));
        this.goalSelector.add(2, new WanderAroundFarGoal(this, 0.35f, 100f));
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(EgyptianCaravanEntity.class, TrackedDataHandlerRegistry.INTEGER);
