...
public class ThrowingAxeManEntity extends NorseEntity implements IAnimatable, IAnimationTickable {
    ...
    public static final TrackedData<String> ATTACK_NAME = DataTracker.registerData(ThrowingAxeManEntity.class,
    ...
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANT =
            DataTracker.registerData(ThrowingAxeManEntity.class, TrackedDataHandlerRegistry.INTEGER);
