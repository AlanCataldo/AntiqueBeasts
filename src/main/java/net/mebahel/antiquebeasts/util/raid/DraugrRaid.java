...
public class DraugrRaid {
    ...
    public DraugrRaid(PlayerEntity player, ServerWorld world) {
        ...
        this.raidBossBar = new ServerBossBar(Text.translatable("antiquebeasts.draugr_raid.wave_msg"),
        ...
        raidBossBar.setName(Text.translatable(
                "antiquebeasts.draugr_raid.wave_msg",
                currentWave
        ));
        registerEvents();
    }
    ...
    private static void stopAllRaids() {
        for (DraugrRaid raid : new ArrayList<>(AntiqueBeasts.ongoingRaids)) {
            raid.endRaid();
        }
    ...
    public void saveRaid() {
        DraugrRaidPersistentData data = DraugrRaidPersistentData.get(world);
    ...
    private void spawnWaveMobs(ServerWorld world) {
        ...
        DraugrRaidState raidState = DraugrRaidStateManager.getRaidState(world);
