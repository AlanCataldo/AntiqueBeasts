...
public class DraugrRaidState extends PersistentState {
    ...
    public static DraugrRaidState fromNbt(NbtCompound nbt) {
        DraugrRaidState state = new DraugrRaidState();
