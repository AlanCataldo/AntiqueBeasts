...
public class GreekChestBlockEntity extends ChestBlockEntity implements GeoBlockEntity, ExtendedScreenHandlerFactory {
    ...
    public GreekChestBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.GREEK_CHEST_ENTITY, pos, state);
